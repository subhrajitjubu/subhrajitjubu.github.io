...
<strong>RAINFALL (mm/day):</strong> ${feature.properties.RAINFALL} mm`);
    ...
    Highcharts.chart('chart-container', {
        ...
        title: {
            text: `Monthly climatological average Rainfall for ${district}`
        },
        subtitle: {
        ...
        yAxis: {
            title: {
                text: 'Monthly climatological average Rainfall (mm/month)'
            }
        },
    //     tooltip: {
    ...
    //   },
        tooltip:
        {
            ...
            pointFormat: '<p style="font-size:16px;margin:0px;padding-top:1px;padding-bottom:1px;color:{series.color};">{series.name} <strong>{point.y}</strong></p>',
            valueDecimals: 2,
